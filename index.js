...
function getNumUnfunded() {
    const numUnfunded = GAMES_JSON.filter( game => game.pledged < game.goal);
    return numUnfunded.length;
}

// create a string that explains the number of unfunded games using the ternary operator
const numUnfunded = getNumUnfunded();
const displayStr = `${numUnfunded > 1 ? `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${numUnfunded} games remain unfunded. We need your help to fund these amazing games!` : `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${numUnfunded} game remains unfunded. We need your help to fund these amazing games!` }`;
// create a new DOM element containing the template string and append it to the description container
const newPara = document.createElement("p");
newPara.innerHTML = displayStr;

const descContainer = document.getElementById("description-container");
descContainer.appendChild(newPara);
/************************************************************************************
